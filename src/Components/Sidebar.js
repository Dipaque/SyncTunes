    ...
    <React.Fragment>
      <div className='bg-zinc-900'>
        ...
        <img  src={logo} height={10} width={20} className='' /> <b className='mt-2 ml-2'>SyncTunes</b>
          ...
          {
            sessionStorage.getItem('roomCode')?(<div className='bg-zinc-900 flex flex-row justify-around p-3 items-center'>
              ...
              Cookies.get('photoUrl') ? ( 
                <Dropdown isOpen={dropdownOpen} toggle={toggle} direction={'down'}>
                  ...
                  <DropdownMenu className='dropdown-menu-end bg-dark' >
                    <DropdownItem className='bg-dark text-sm text-white d-flex justify-center items-center gap-1'>
